...
const restaurantGroupResolvers = {
    ...
    Mutation: {
      createRestaurantGroup: async (_parent, { name, description, restaurants }) => {
        return await restaurantGroupService.createRestaurantGroup(name, description, restaurants);
      }
    }
};
